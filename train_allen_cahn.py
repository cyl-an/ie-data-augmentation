...
from neuralop.datasets import load_allen_cahn_pt
from neuralop.training import setup
from neuralop.training.callbacks import MGPatchingCallback, SimpleWandBLoggerCallback
from neuralop.utils import count_params

# read configure.yaml
with open('configure/allen_cahn_0.05.yaml', 'r') as file:
...
dataset_params['data_path'] = dataset_params['data_path'].format(pde_params['epsilon'])
model_params['save_path'] = model_params['save_path'].format(pde_params['epsilon'])

# Loading the dataset
train_loader, test_loaders = load_allen_cahn_pt(
    ...
    pde_params_epsilon=pde_params['epsilon']
)
